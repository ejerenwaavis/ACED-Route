...
import { X, Map, DownloadCloud, Trash2, RefreshCw, CheckCircle, Wifi, Compass, AlertCircle } from 'lucide-react';
                  ...
                  <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '0.5rem', marginTop: '0.25rem' }}>
                    {isInstalled ? (
                      ...
                      >
                        ...
                        <span>{isBusy === 'downloading' ? 'Downloading...' : 'Download Bundle'}</span>
                      </button>
                    )}
                  </div>
                </div>
